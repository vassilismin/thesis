...
for (i in 1:N_params) {
  ...
  P_1<-params[1] #liver
  P_2<-params[2] #spleen
  P_3<-params[3] #kidneys lungs blood
  P_4<-params[4] #heart uterus
  P_5<-params[5] #Skeleton Soft tissue 
  P_6<-params[6] #brain
  
  x_1<-params[7] #liver
  x_2<-params[8] #spleen
  x_3<-params[9] #kidneys lungs blood
  x_4<-params[10] #heart uterus
  x_5<-params[11] #Skeleton Soft tissue
  x_6<-params[12] #brain
  
  k_de<-params[13]
  Km<-params[14] #micro-g/ml 
  Pup<-params[15] #ml/h/(ml pcs)
