...
###############################################################################################
Kp <- c(0.56, 3.34, 0.76, 0.46, 0.86, 0.32, 0.73, 2.2, 0.75, 0.53, 0.71, 1.35) 
T_inf <- (1/60)/2
FUB<-0.015/0.65

#load data
diaz_data <- read.xlsx("diaz_data_missing.xlsx", colNames = TRUE,rowNames = TRUE)
...
#collapse concentration matrix to a vector and remove missing values
...
#create a variable to store for each patient the number of samples
